...
print (" {} plus {} The sum of this is € {}" .format (x, y, answer)) #prints out the answer in a human readable format with a euro sign and decimal point between the euro and cent 
